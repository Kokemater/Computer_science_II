...
int main(void)
{
	...
	min_element_index(diferencia_centrada_2, i_d2, j_d2, find_by_absolut_value);
	min_element_index(progresivas2, i_p2, j_p2,find_by_absolut_value);
	min_element_index(regresivas2, i_r2, j_r2,find_by_absolut_value);
	min_element_index(diferencia_centrada_3, i_d3, j_d3,find_by_absolut_value);
	min_element_index(progresivas3, i_p3, j_p3,find_by_absolut_value);
	min_element_index(regresivas3, i_d3, j_d3,find_by_absolut_value);
